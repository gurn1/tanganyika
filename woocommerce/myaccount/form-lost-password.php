...
<form method="post" class="woocommerce-ResetPassword lost_reset_password">
	...
	<p class="woocommerce-form-row woocommerce-form-row--first form-row form-row-first">
		...
		<input class="woocommerce-Input woocommerce-Input--text input-text" type="text" name="user_login" id="user_login" value="<?php echo isset($_GET['email']) ? $_GET['email'] : ''; ?>" autocomplete="username" />
	</p>
