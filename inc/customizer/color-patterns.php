<?php
/**
 * Tanganyika: Color Patterns
 *
 * @package WordPress
 * @subpackage raven_theme
 * @since 1.0
 */
 ...
 */
function raven_theme_custom_colors_css() {
	...
	/**
	 * Filter Tanganyika default saturation level.
	 *
	 * @since Tanganyika 1.0
	 *
	 * @param int $saturation Color saturation level.
	 */
	$saturation = apply_filters( 'raven_theme_custom_colors_saturation', 100 );
	$saturation = absint( $saturation ) . '%';

	/**
	 * Filter Tanganyika default selection saturation level.
	 *
	 * @since Tanganyika 1.0
	 *
	 * @param int $saturation_selection Selection color saturation level.
	 */
	$saturation_selection = absint( apply_filters( 'raven_theme_custom_colors_saturation_selection', 50 ) );
	$saturation_selection = $saturation_selection . '%';

	/**
	 * Filter Tanganyika default lightness level.
	 *
	 * @since Tanganyika 1.0
	 *
	 * @param int $lightness Color lightness level.
	 */
	$lightness = apply_filters( 'raven_theme_custom_colors_lightness', 33 );
	$lightness = absint( $lightness ) . '%';

	/**
	 * Filter Tanganyika default hover lightness level.
	 *
	 * @since Tanganyika 1.0
	 *
	 * @param int $lightness_hover Hover color lightness level.
	 */
	$lightness_hover = apply_filters( 'raven_theme_custom_colors_lightness_hover', 23 );
	$lightness_hover = absint( $lightness_hover ) . '%';

	/**
	 * Filter Tanganyika default selection lightness level.
	 *
	 * @since Tanganyika 1.0
	 *
	 * @param int $lightness_selection Selection color lightness level.
	 */
	$lightness_selection = apply_filters( 'raven_theme_custom_colors_lightness_selection', 90 );
	...
	/**
	 * Filters Tanganyika custom colors CSS.
	 *
	 * @since Tanganyika 1.0
	 *
	 ...
	 */
	return apply_filters( 'raven_theme_custom_colors_css', $theme_css, $primary_color, $saturation );
}
